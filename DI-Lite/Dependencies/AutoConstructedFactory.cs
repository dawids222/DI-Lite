...
namespace DI_Lite.Dependencies
{
    internal class AutoConstructedFactory<ReferenceType, ConcreteType>
        : Factory<ReferenceType>, IAutoConstructedDependency
        where ConcreteType : class, ReferenceType
    {
        private readonly AutoConstructor<ReferenceType, ConcreteType> _constructor;

        internal AutoConstructedFactory(AutoConstructor<ReferenceType, ConcreteType> constructor) : base(constructor.Creator)
        {
